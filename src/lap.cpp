...
std::shared_ptr< LapCost > LapCost::instance()
{
  if(!m_instance)
  {
    m_instance = std::shared_ptr<LapCost>(new LapCost);
  }
  return m_instance;
}
...
int LapCost::lap(int dim, const std::vector< std::vector<int> >& assigncost,
...
void LapCost::checklap(int dim, cost **assigncost,
              col *rowsol, row *colsol, cost *u, cost *v)
{
  ...
  for (i = 0; i < dim; i++)  
    for (j = 0; j < dim; j++)  
      ...
      {
	std::cout << std::endl;
        std::cout << "negative reduced cost i " << i << " j " << j << " redcost " << redcost << std::endl;;
        std::cout << "\n\ndim %5d - press key\n" << std::endl;
        std::cin >> dim;
        break; 
      }
  ...
  for (i = 0; i < dim; i++)  
    ...
    {
      std::cout << std::endl;
      std::cout << "non-null reduced cost i " << i << " soli " <<  rowsol[i] << " redcost " << redcost << std::endl;;
      std::cout << "\n\ndim %5d - press key\n" << std::endl;
      std::cin >> dim;
      break; 
    }
  ...
  for (i = 0; i < dim; i++)  
    ...
    {
      std::cout << std::endl;
      std::cout << "column matched more than once - i " << i << " soli " <<  rowsol[i] << std::endl;;
      std::cout << "\n\ndim %5d - press key\n" << std::endl;
      std::cin >> dim;
      break; 
    }
  ...
  for (i = 0; i < dim; i++)  
    ...
    {
      std::cout << std::endl;
      std::cout << "error in row solution i  " << i << " soli " <<  rowsol[i] << " solsoli " << colsol[rowsol[i]] << std::endl;;
      std::cout << "\n\ndim %5d - press key\n" << std::endl;
      std::cin >> dim;
      break; 
    }
  ...
  for (j = 0; j < dim; j++)  
    ...
    {
      std::cout << std::endl;
      std::cout << "error in col solution j  " << j << " solj " <<  colsol[i] << " solsolj " << rowsol[colsol[j]] << std::endl;;
      std::cout << "\n\ndim %5d - press key\n" << std::endl;
      std::cin >> dim;
      break; 
    }
